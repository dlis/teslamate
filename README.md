...
new password will be generated. Note that re-configuring the stack always generates a new password, so log in again in
the browser tabs which were opened before it.
